...
最大７つのYES/NOの質問に答えてください。

家計の現在地と次のステップが、ざっくり提示されます。
...
<details>
  ...
  <details>
    ...
    ※持ち家は、団体信用生命保険等によって残債が無くなれば、残された家族などの住宅費を軽減する手段となり得る</details>
</details>
  ...
  <details>
    <summary>NO</summary>　現在地：🧗
      ...
      <ul>
        ...
        <li>
          <strong>NISAと投資信託で、積立投資する AND/OR</strong>
        </li>
        <li>
...
<details>
  ...
  <details>
    <summary>NO</summary>　現在地：🏄
      ...
      <ul>
        <li>
          <strong>NISAと投資信託で、長期・積立投資する AND/OR</strong>
        </li>
        <li>
          <strong>iDeCo／企業型DCと投資信託で、長期・積立投資する AND/OR</strong>
        </li>
        <li>
